...
import { CaretDownIcon, ThumbsUpIcon, ThumbsDownIcon } from "@phosphor-icons/react"
            ...
            <BubbleContent className="whitespace-pre-line">
              ...
              {isLong ? (
                ...
                >
                  ...
                  <CaretDownIcon data-icon="inline-end" className="group-data-panel-open/button:rotate-180" />
                </CollapsibleTrigger>
              ) : null}
            </BubbleContent>
          </Bubble>
