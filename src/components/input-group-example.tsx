...
import { MagnifyingGlassIcon, EyeSlashIcon, MicrophoneIcon, RecordIcon, InfoIcon, StarIcon, CopyIcon, TrashIcon, CaretDownIcon, SparkleIcon, CheckIcon, EnvelopeIcon, ArrowSquareOutIcon, ArrowUpIcon, CodeIcon, ArrowClockwiseIcon } from "@phosphor-icons/react"
      ...
      <FieldGroup>
        ...
        <Field>
          ...
          <InputGroup>
            ...
            <InputGroupAddon align="inline-end">
              <RecordIcon className="animate-pulse text-red-500" />
            </InputGroupAddon>
          </InputGroup>
        </Field>
        <Field>
